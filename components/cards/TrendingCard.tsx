      ...
      <article className="grid gap-4 rounded-xl border border-zinc-800 bg-zinc-900 p-4 transition hover:border-cyan-500 sm:grid-cols-[160px_1fr]">
        ...
        <div className="min-w-0">
          <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
            ...
            <p className="text-sm font-semibold text-emerald-400">{formatDelta(game.playerDelta)} players</p>
          </div>

          <div className="mt-4 grid gap-3 text-sm sm:grid-cols-3">
            <div>
              <p className="text-zinc-500">Growth</p>
              <p className="mt-1 font-semibold text-white">{game.growthPercent.toFixed(1)}%</p>
            </div>
            ...
            <div>
              <p className="text-zinc-500">Visits Delta</p>
              <p className="mt-1 font-semibold text-white">{formatDelta(game.visitDelta)}</p>
            </div>
          </div>
        </div>
      </article>
