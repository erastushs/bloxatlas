  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-12">
      <section className="mb-8">
        <p className="text-sm font-semibold uppercase tracking-wide text-cyan-400">Collector Freshness</p>
      ...
      {!isLoading && !error && games.length === 0 ? (
        <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-10 text-center">
          ...
          <p className="mt-2 text-zinc-400">Games will appear here after the collector writes sync timestamps.</p>
        </div>
      ) : null}
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {games.map((game) => (
            <div key={game.id} className="relative">
              ...
              <div className="absolute right-3 top-3 z-10 max-w-[70%] rounded-md border border-zinc-700 bg-zinc-950/90 px-2 py-1 text-xs font-medium text-zinc-300">
