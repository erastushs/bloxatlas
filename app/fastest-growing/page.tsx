  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-12">
      <section className="mb-8">
        <p className="text-sm font-semibold uppercase tracking-wide text-cyan-400">Growth Ranking</p>
        <h1 className="mt-2 text-4xl font-bold">Fastest Growing Games</h1>
        <p className="mt-3 max-w-2xl text-zinc-400">
          Games with the strongest player growth rate across recent collected snapshots.
        </p>
      </section>
      ...
      {!isLoading && !error && games.length === 0 ? (
        <div className="rounded-xl border border-zinc-800 bg-zinc-900 p-10 text-center">
          <h2 className="text-xl font-semibold">No growing games yet</h2>
          <p className="mt-2 text-zinc-400">Collect at least two snapshots per game to calculate growth rate.</p>
        </div>
      ) : null}
